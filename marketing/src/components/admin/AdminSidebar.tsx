...
export default function AdminSidebar({ isOpen, onClose }: AdminSidebarProps) {
  ...
  const navItems = [
    ...
    { href: '/demo/admin/orders', label: 'Orders', icon: ChefHat },
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full">
        ...
        <div className="p-6 border-b border-[#F0EDE8]/50 relative">
             <Link href="/demo/admin/dashboard" className="flex items-center gap-2" onClick={onClose}>
        ...
        <div className="p-4 border-t border-[#F0EDE8]">
            <p className="text-[10px] font-black text-[#A68966] uppercase tracking-[0.3em] text-center">
