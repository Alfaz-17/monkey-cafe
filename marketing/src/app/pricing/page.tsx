...
const plans = [
  {
    id: "basic",
    name: "Foundation",
    fullName: "Boutique & Small Venue Suite",
    price: "₹10k – ₹25k",
    period: "PER ANNUM",
    purpose: "Essential digital presence",
    color: "text-zinc-500",
    accent: "bg-[#6F4E37]",
    ...
    includes: [
      "Signature Branded QR Menu",
      "Standard Dish Psychology",
      "Instant Cloud Infrastructure",
      "Engagement Analytics",
      "Quarterly ROI Review",
    ],
    variesOn: ["Menu Size", "Language Needs"],
  },
  {
    id: "comfort",
    name: "Elevation",
    fullName: "Family Dining Experience",
    price: "₹30k – ₹60k",
    period: "PER ANNUM",
    purpose: "Warm & comfortable browsing",
    color: "text-zinc-800",
    accent: "bg-[#6F4E37]",
    ...
    includes: [
      ...
      "Bespoke Family-First Layout",
      "Visual Taste Profiling",
      "Smart Combo Engineering",
      "Priority Ordering Flow",
    ],
    variesOn: ["Graphic Customization", "Guest Volume"],
  },
  {
    id: "smart",
    name: "Architect",
    fullName: "Premium & Fine Dining",
    price: "₹80k – ₹1.4L",
    period: "PER ANNUM",
    purpose: "Upscale brand immersion",
    color: "text-[#6F4E37]",
    accent: "bg-[#6F4E37]",
    border: "border-[#6F4E37]/30",
    shadow: "shadow-[0_32px_64px_rgba(111,78,55,0.1)]",
    recommended: true,
    bestFor: ["Fine Dining", "Luxury Landmarks", "High-Volume High-Street"],
    includes: [
      "Everything in Elevation",
      "Luxury Typography & Motion",
      "AI Hospitality Assistant Prep",
      "Predictive Guest Intelligence",
      "High-Load Architecture",
    ],
    variesOn: ["Custom Animation", "API Integrations"],
  },
  {
    id: "premium",
    name: "Enterprise",
    fullName: "Global Group Governance",
    price: "₹1.8L – ₹3L+",
    period: "PER ANNUM",
    purpose: "Multi-location brand standards",
    color: "text-zinc-900",
    accent: "bg-zinc-900",
    border: "border-zinc-900/10",
    shadow: "shadow-[0_48px_100px_rgba(0,0,0,0.08)]",
    bestFor: ["Hotels & Resorts", "National Franchises", "Multi-Unit Groups"],
    includes: [
      "Everything in Architect",
      "Cross-Brand Governance",
      "Infinite Custom UI Themes",
      "Strategic Success Director",
      "On-Site Operational Setup",
    ],
    variesOn: ["Outlet Density", "Custom Modules"],
  },
];
...
const quizSteps = [
  ...
  },
  {
    ...
    options: [
      { id: "small", label: "Agile Menu", description: "Under 50 curated items", score: 1, multiplier: 1, icon: RefreshCcw },
      { id: "medium", label: "Standard Selection", description: "50 to 150 diverse items", score: 2, multiplier: 1.2, icon: Utensils },
      { id: "large", label: "Enterprise Portfolio", description: "Over 150 items across tiers", score: 3, multiplier: 1.5, icon: Globe },
    ],
  },
  {
    id: "capacity",
    title: "What is your seating capacity?",
    subtitle: "Table size determines the required hardware concurrency.",
    options: [
      { id: "small", label: "Up to 10 Tables", description: "Small boutique or kiosk", score: 1, surcharge: 0, icon: Store },
      { id: "mid", label: "10 - 40 Tables", description: "Standard mid-sized venue", score: 2, surcharge: 15000, icon: Utensils },
      { id: "large", label: "40+ Tables", description: "High-volume flagship location", score: 3, surcharge: 38000, icon: Building },
    ],
  },
];
...
export default function PricingPage() {
  ...
  const analyticsCalculation = useMemo(() => {
    ...
    return {
      ...
      plan,
      breakdown: [
        { label: "Base Complexity", value: `₹${(baseCost / 1000).toFixed(0)}k` },
        { label: "Volume Multiplier", value: `${multiplier}x` },
        { label: "Hardware Surcharge", value: `+₹${(surcharge / 1000).toFixed(0)}k` }
      ]
    };
